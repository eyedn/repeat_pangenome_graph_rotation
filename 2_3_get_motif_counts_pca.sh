...
input=/project/mchaisso_100/cmb-17/vntr_genotyping/aydin/data/motif_data.csv
genomes_to_remove=/project/mchaisso_100/cmb-17/vntr_genotyping/aydin/genomes.1kg_plus_related.gt_HPRC.txt
out=/project/mchaisso_100/cmb-17/vntr_genotyping/aydin/data/motif_pca.csv

python3 ./python_scripts/get_motif_counts_pca.py $input $genomes_to_remove $out
